...
-- Type your code below:
SELECT COUNT(id) AS number_movies ,Year FROM movie
...
-- Type your code below:
SELECT genre,count(id) as num_movies FROM 
movie
inner join genre
...
-- Type your code below:
WITH movie_onegenre AS 
(SELECT movie_id FROM genre
GROUP BY movie_id
HAVING COUNT(genre)=1)
SELECT COUNT(*) FROM movie_onegenre;
...
+------------------+-------------------+---------------------+*/
-- Type your code below:
WITH prod_company_moviecount_rank AS
(SELECT production_company,count(movie_id),
...
SELECT * FROM prod_company_moviecount_rank
...
SELECT *,RANK() 
OVER (ORDER BY actress_avg_rating DESC) 
AS actress_rank 
